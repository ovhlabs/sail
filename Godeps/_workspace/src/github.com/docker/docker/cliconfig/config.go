...
import (
	...
	"stash.ovh.net/sailabove/sailgo/Godeps/_workspace/src/github.com/docker/docker/pkg/homedir"
	"stash.ovh.net/sailabove/sailgo/Godeps/_workspace/src/github.com/docker/docker/pkg/system"
)
