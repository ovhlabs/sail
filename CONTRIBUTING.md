...
- Code must be formated with `go fmt`, pass `go vet
...
sail is licensed under a (modified) BSD license. Anything contributed to
sail must be released under this license.
